...
public class BinarySearchTreeTester {
	...
	static void compare_lists (String[] key_expected, int[] value_expected, int count, List<Entry<String, Integer> > l) {
		...
		displayResults( count == l.size());//passed
		//System.out.println("Count: " + count + " size: " + l.size());
		...
		displayResults(!failed);//test failed. My tree is a mirror of the expected tree.
	}
	...
	static void tree1_test() {
		...
		//System.out.println("Before compare");//my code
